...
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | --------------------------------------------- |
| **Google Photos** — Pinch-to-zoom Grid    | <img src="./src/GooglePhotos/assets/google-photo-grid-list.png" width="300" />                             | [YouTube](https://youtu.be/I4eRKuMuG4o)                | [Source](./src/GooglePhotos)                  |
| **ChatGPT** — Voice Profiles Fluid Orb    | <img src="./src/ChatGPTVoiceProfiles/assets/ChatGPT_voice_profiles_orb.png" width="300" />                 | [YouTube](https://youtu.be/wbfCDYvMx4U)                | [Source](./src/ChatGPTVoiceProfiles)          |
| **Threads** — Spoiler Masking             | <img src="./src/ThreadsSpoilerMasking/assets/threads-spoiler-masking.png" width="300" />                   | [YouTube](https://youtu.be/30qn0e2zHNo)                | [Source](./src/ThreadsSpoilerMasking)         |
